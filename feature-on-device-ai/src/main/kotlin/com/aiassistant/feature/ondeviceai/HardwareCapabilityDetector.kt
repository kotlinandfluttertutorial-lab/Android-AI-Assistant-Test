 ...
 */
data class HardwareCapability(val isSupported: Boolean, val availableBytes: Long, val vendorInfo: String?)
 ...
 */
@Singleton
class HardwareCapabilityDetector @Inject constructor(@ApplicationContext private val context: Context) {
