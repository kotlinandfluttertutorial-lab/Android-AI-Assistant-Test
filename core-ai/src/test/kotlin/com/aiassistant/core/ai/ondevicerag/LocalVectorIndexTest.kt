...
class LocalVectorIndexTest :
    DescribeSpec({
        ...
        fun fakeEntity(id: String, userId: String, documentId: String = "doc1", embedding: FloatArray) =
            OnDeviceChunkEntity(
                id = id,
                userId = userId,
        ...
        fun unitVec(dim: Int, hotIndex: Int): FloatArray = FloatArray(dim).also { it[hotIndex] = 1f }
