...
& $gcloud run deploy ai-assistant-backend `
    ...
    --port=8000 `
    --set-secrets="SECRET_KEY=SECRET_KEY:3,AES_ENCRYPTION_KEY=AES_ENCRYPTION_KEY:3,DATABASE_URL=DATABASE_URL:5,REDIS_URL=REDIS_URL:3,MINIO_ACCESS_KEY=MINIO_ACCESS_KEY:3,MINIO_SECRET_KEY=MINIO_SECRET_KEY:3,OPENAI_API_KEY=OPENAI_API_KEY:3,GEMINI_API_KEY=GEMINI_API_KEY:6" `
